{!! Form::open(['route' => 'campaign.newRegistrationCustomer', 'autocomplete' => 'off']) !!}
<div class="task-section setting-section">
	<h5>New Registration ( for customer )</h5>
	<span class="label">Subject</span>
	@php 

		$subject = App\Models\Option::where('key','new_registration_customer_subject' )->value('value'); 
		$body    = App\Models\Option::where('key','new_registration_customer_body' )->value('value'); 
