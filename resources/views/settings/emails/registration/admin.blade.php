{!! Form::open(['route' => 'campaign.newRegistrationAdmin', 'autocomplete' => 'off']) !!}
<div class="task-section setting-section">
	<h5>New Registration ( for Pacom Internal User )</h5>
	<span class="label">Subject</span>
	@php 

		$subject = App\Models\Option::where('key','new_registration_admin_subject' )->value('value'); 
		$body    = App\Models\Option::where('key','new_registration_admin_body' )->value('value'); 
