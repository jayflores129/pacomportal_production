      ...
      <div class="panel panel-top">
        <div class="grid justify-space-between">
          ...
          <div class="col text-right">
            <a href="{{ url('admin/itemstatus/create') }}" class="btn-brand btn-brand-icon btn-brand-primary"><i class="fa fa-check btn-pencil"></i><span>Create Request Status</span></a>
          </div>
        </div>
      </div> 
    @endif
                         ...
                         <tr>
                             ...
                             <td>
                              <ul class="list-inline">
                                <li><a href="{{ url('admin/itemstatus') }}/{{ $status->id }}/edit" class="btn-brand btn-brand-icon btn-brand-primary"><i class="fa fa-edit btn-icon"></i><span>Edit</span></a></li>
                                <li>
                                  {!! Form::open([
                                 'method' => 'delete',
                                 'route' => ['itemstatus.destroy', $status->id]
                                ]) !!}
