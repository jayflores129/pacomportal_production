...
@section('content')
  ...
  @include('softwares/show/tab')  

  <div class="single-task-content tab-content" style="margin-bottom: 20px;">

    <div id="taskComment" class="tab-pane fade in active">

      @include('softwares/show/comments')

    </div>

    <div id="taskAttachment" class="tab-pane fade in">

      @include('softwares/show/attachment')
    ...
    <div id="taskActivity" class="tab-pane fade in">  
      ...
      @include('softwares/show/activity')
         ...
         xhr: function () {
              ...
              xhr.upload.addEventListener("progress", function (evt) {
                  if (evt.lengthComputable) {
                      ...
                      //$('.attachment-upload-status .percentage-uploaded').html('Uploaded : <span>'+ ( Math.round(percentComplete * 100 ) ) + '%</span>');
